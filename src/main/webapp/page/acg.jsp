...
<link rel="stylesheet" type="text/css" href="${root }/script/acg/acg.css" />
<script type="text/javascript" src="${root }/plugins/angular.js"></script>
<script type="text/javascript" src="${root }/script/acg/acg.js"></script>
...
<body ng-app="acg" ng-controller="acg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="editForm" class="form-horizontal" action="edit.do"
							...
							<div class="col-sm-6">
								<select class="form-control" id="input-season" name="season">
									<c:forEach items="${Season }" var="e">
										<option value="${e.code }"
											<c:if test="${e.code == '1' }">selected</c:if>>${e.text
											}</option>
									</c:forEach>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="input-curr"
									name="curr" placeholder="curr">
							</div>
						</div>
						<div class="form-group">
							<label for="input-total" class="col-sm-3 control-label">total</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="input-total"
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select class="form-control" id="input-serialState"
									name="serialState">
									<c:forEach items="${SerialState }" var="e">
										<option value="${e.code }"
