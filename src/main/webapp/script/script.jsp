...
<script type="text/javascript" src="${root }/plugins/bootstrapvalidator-0.5.3/dist/js/bootstrapValidator.min.js"></script>
...
<link rel="stylesheet" type="text/css" href="${root }/plugins/bootstrapvalidator-0.5.3/dist/css/bootstrapValidator.min.css" />
</html>